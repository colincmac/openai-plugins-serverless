...
document.addEventListener('DOMContentLoaded', () => {
    if (!container) {
        ...
        if (validEnvFile) {
            void AuthHelper.msalInstance.handleRedirectPromise().then((response) => {
                if (response) {
                    AuthHelper.msalInstance?.setActiveAccount(response.account);
                }
            });
        }
            ...
            <React.StrictMode>
                ...
                {validEnvFile && (
                    <ReduxProvider store={store}>
                        ...
                        <MsalProvider instance={AuthHelper.msalInstance!}>
