...
const getSignalRAccessToken = async (instance: IPublicClientApplication, inProgress: InteractionStatus) => {
    return await TokenHelper.getAccessTokenUsingMsal(inProgress, instance, Constants.msal.signalRScopes);
};
